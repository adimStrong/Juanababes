...
def import_csv(filepath):
    ...
    with open(filepath, "r", encoding="utf-8-sig") as f:
        ...
        for row in reader:
            ...
            # REMOVED: Fallback title-any-date and closest-time-60min
            # These were too dangerous and matched wrong posts
            ...
            if match:
                ...
                # No match found — skip (do NOT create csv_ synthetic posts)
                skipped += 1
    ...
    if skipped > 0:
        print(f"  {skipped} rows skipped (no match or missing data)")
    return updated
